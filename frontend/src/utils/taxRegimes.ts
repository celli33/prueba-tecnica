...
interface TaxRegime {
  id: AllowedTaxRegimeId;
  texto: string;
  aplica_fisica: boolean;
  aplica_moral: boolean;
}

const cfdi40RegimenesFiscales: TaxRegime[] = [
  {
    id: '601',
  ...
  {
    id: '607',
    texto: 'Régimen de Enajenación o Adquisición de Bienes',
    aplica_fisica: true,
    aplica_moral: false,
  },
  {
  ...
  {
    id: '615',
    texto: 'Régimen de los ingresos por obtención de premios',
    aplica_fisica: true,
    aplica_moral: false,
  },
  {
  ...
  {
    id: '625',
    texto: 'Régimen de las Actividades Empresariales con ingresos a través de Plataformas Tecnológicas',
    aplica_fisica: true,
    aplica_moral: false,
  },
  {
    id: '626',
    texto: 'Régimen Simplificado de Confianza',
    aplica_fisica: true,
    aplica_moral: true,
  },
];
